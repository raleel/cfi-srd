...
3. Vous pouvez effectuer tout ce processus via le navigateur sans connaître git. Cependant, apprendre à utiliser GitHub Desktop vous permettra de tester vos modifications localement avant de les publier pour que le monde entier puisse les voir.
...
8. Assurez-vous d'avoir le fichier ".nojekyll" ; c'est un fichier vide nécessaire lors de l'hébergement d'un site web sur Github, sans quoi le SRD ne s'affichera pas correctement. *(Indique à GitHub Pages de ne pas traiter les fichiers publiés via Jekyll).*
...
Le langage Markdown est très facile à apprendre ; utilisez le lien fourni au point 2 de la section Prérequis ci-dessus pour obtenir la liste complète de la syntaxe.

### _Sidebar.md

Il s'agit de votre menu, le volet de navigation sur le côté gauche du site web. Une fois que vous avez ajouté un fichier markdown à votre dépôt, vous devez ajouter le fichier ici afin que son contenu soit inclus. Suivez la mise en forme existante.
...
3. Si vous n'avez pas rendu le dépôt "public", vous avez deux choix :
    a. Rendre le dépôt public, ce qui vous permettra d'utiliser Github Pages pour héberger gratuitement votre site web SRD.
