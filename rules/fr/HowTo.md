...
2. Vous devrez créer un compte [GitHub](https://github.com/) gratuit si vous n'en avez pas. Nous vous recommandons d'utiliser le nom de votre jeu de rôle, car cela fera partie de l'URL que les gens utiliseront pour accéder à votre SRD. 

3. Vous pouvez effectuer tout ce processus via le navigateur sans connaître git. Cependant, apprendre GitHub Desktop vous permettra de tester localement toute modification avant de la déployer en direct pour que le monde entier puisse la voir.
...
3. Si vous n'avez pas rendu le dépôt 'public', vous avez deux choix :
    ...
    b. Mettre à niveau votre compte Github (au moment de l'écriture de ce document, cela coûte 4 $ par mois ou 48 $ de frais annuels)
...
3. Modifiez-les pour les polices que vous souhaitez utiliser
