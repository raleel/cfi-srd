...
8. Assurez-vous d'avoir le fichier ".nojekyll". Il s'agit d'un fichier vide nécessaire lors de l'hébergement d'un site web sur Github, sans quoi le SRD ne s'affichera pas correctement. *(Indique à GitHub Pages de ne pas traiter les fichiers publiés via Jekyll).*
...
Ceci est votre menu, le volet de navigation sur le côté gauche du site web. Une fois que vous avez ajouté un fichier markdown à votre dépôt, vous devez ajouter le fichier ici pour que son contenu soit inclus. Suivez la mise en forme existante.
...
6. Vous verrez maintenant votre URL, par exemple https://coweater.github.io/mysrd/
