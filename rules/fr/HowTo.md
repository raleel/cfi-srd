...
> Si vous possédez un nom de domaine, vous pouvez l'utiliser avec ce processus pour créer un SRD comme je l'ai fait pour https://srd.7thextinctionrpg.com
...
3. Si vous n'avez pas rendu le dépôt 'public', vous avez deux choix :
    ...
    b. Mettre à niveau votre compte Github (au moment de la rédaction de ce document, cela coûte 4 $ par mois ou 48 $ par an).
...
Utilisez Fontawesome pour obtenir des icônes gratuites et animées. Les utilisateurs abonnés peuvent utiliser les icônes Pro.
