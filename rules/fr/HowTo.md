...
3. Vous pouvez réaliser tout ce processus via le navigateur sans connaître git. Cependant, apprendre Github Desktop vous permettra de tester vos modifications localement avant de les déployer en ligne pour que le monde puisse les voir.
...
8. Assurez-vous d'avoir le fichier ".nojekyll", c'est un fichier vide nécessaire lors de l'hébergement d'un site web sur Github, sinon le SRD ne s'affichera pas correctement. *(Indique à GitHub Pages de ne pas traiter les fichiers publiés via Jekyll).*
...
Il s'agit de votre menu, le volet de navigation sur le côté gauche du site web. Une fois que vous avez ajouté un fichier markdown à votre dépôt, vous devez y ajouter le fichier ici pour que son contenu soit inclus. Suivez la mise en forme existante.
...
5. Attendez 10 à 20 secondes puis rafraîchissez la page
