...
2. You will need to create a free [GitHub](https://github.com/) account if you don't have one. We recommend you use the name of your RPG as this will become part of the URL people will use to access your SRD. 
...
Use Fontawesome to get free icons and animated icons. Subscribed users can use Pro Icons
