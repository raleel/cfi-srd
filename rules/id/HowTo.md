...
3. Anda dapat melakukan seluruh proses ini melalui browser tanpa perlu mengerti git. Meskipun mempelajari github desktop akan memungkinkan Anda untuk menguji perubahan apa pun secara lokal sebelum menerapkannya secara langsung untuk dilihat dunia.
...
8. Pastikan Anda memiliki berkas ".nojekyll", ini adalah berkas kosong yang diperlukan saat meng-hosting situs web di Github, jika tidak, SRD tidak akan ditampilkan dengan benar. *(Memberitahu GitHub Pages untuk tidak menjalankan berkas yang dipublikasikan melalui Jekyll).*
...
2. Salin & masukkan tautan rentang web secara langsung ke dalam berkas markdown Anda
