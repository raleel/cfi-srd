...
| **Rank** : Mag 0 | **Casting Time** : 1 Turn |
| --- | --- |
...
| **Rank** : Mag 1 | **Casting Time** : 1 Round |
| --- | --- |
...
| **Rank** : Clr 5, Mag 5 | **Casting Time** : 2 Actions |
| :-- | :-- |
...
| **Rank** : Clr 2 | **Casting Time** : 2 Minutes |
| --- | --- |
...
| **Rank** : Clr 0, Mag 0 | **Casting Time** : Instant |
| --- | --- |
...
| **Rank** : Clr 0, Mag 0 | **Casting Time** : 1 Turn |
| --- | --- |
...
| **Rank** : Clr 4 | **Casting Time** : 2 Actions |
| --- | --- |
...
| **Rank** : Mag 1 | **Casting Time** : 1 Action |
| --- | --- |
| **Sphere** : None | **Duration** : Instant |
...
| **Int** | **Cost** | **Min Rank** | **Variable Effect** |
| --- | --- | --- | --- |
...
| **Rank** : Clr 0 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Mag 4 | **Casting Time** : 2 Actions |
| --- | --- |
| **Sphere** : None | **Duration** : Instant |
...
| **Rank** : Clr 2 | **Casting Time** : 2 Actions |
| --- | --- |
...
| **Rank** : Mag 5 | **Casting Time** : 2 Rounds |
| --- | --- |
| **Sphere** : None | **Duration** : 1 Week/Intensity |
...
| **Rank** : Mag 3 | **Casting Time** : 2 Actions |
| --- | --- |
| **Sphere** : None | **Duration** : 1 Week/Intensity |
...
| **Rank** : Mag 0 | **Casting Time** : 1 Action |
| --- | --- |
| **Sphere** : None | **Duration** : Instant |
| **Cost** : 1 | **Range** : Touch |
| **Area** : 1 Target | **Resist** : None |
...
| **Rank** : Mag 3 | **Casting Time** : 1 Round |
| --- | --- |
| **Sphere** : None | **Duration** : Instant |
| **Cost** : 3+1/additional Intensity | **Range** : 0 |
| **Area** : See Below | **Resist** : Evade |
...
| **Rank** : Clr 4, Mag 3 | **Casting Time** : 2 Actions |
| --- | --- |
...
When this spell is cast, 1d4 creatures of SIZ 1-20 within the area of affect that Fail their Resistance roll will be struck with a magical confusion. Each additional level of Intensity will affect another 1d4 creatures to a maximum of 4d4. The cleric version effects 1d3+1 per Intensity and has no Maximum. Those within the Area of Effect and closest to the caster are affected first. A successful Resistance roll overcomes the spell, while a Failed roll results in the victim suffering from one of the following random effects, roll every Round for the spell's Duration, or until the victim wanders off.
...
| **Rank** : Clr 2, Mag 2 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Clr 5, Mag 4 | **Casting Time** : 10 Minutes |
| --- | --- |
...
| **Rank** : Clr 0, Mag 0 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Clr 1 | **Casting Time** : 1 Minute |
| --- | --- |
...
| **Rank** : Clr 2 | **Casting Time** : 1 Round |
| --- | --- |
...
| **Rank** : Clr 1 | **Casting Time** : 2 Action |
| --- | --- |
...
| **Rank** : Clr 1 | **Casting Time** : 2 Actions |
| --- | --- |
| **Sphere** : Healing | **Duration** : Permanent |
...
| **Rank** : Mag 2 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Mag 2 | **Casting Time** : 1 Minute |
| --- | --- |
...
| **Rank** : Clr 1, Mag 2 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Clr 1, Mag 1 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Mag 3 | **Casting Time** : 1 Action |
| --- | --- |
| **Sphere** : None | **Duration** : Instant |
| **Cost** : 3+1/additional Intensity | **Range** : 0 |
| **Area** : Caster | **Resist** : N/A |
...
| **Rank** : Clr 2, Mag 2 | **Casting Time** : 2 Actions |
| --- | --- |
| **Sphere** : Protection | **Duration** : Instant |
| **Cost** : 1 | **Range** : 360 ft. |
...
| **Rank** : Clr 3 | **Casting Time** : 10 Minutes |
| --- | --- |
...
| **Rank** : Clr 5, Mag 5 | **Casting Time** : 10 Minutes1 Action |
| --- | --- |
...
| **Int** | **Cost** | **Variable Effect** | **Potential Damage** |
| --- | --- | --- | --- |
...
| **Rank** : Mag 4 | **Casting Time** : See Below |
| --- | --- |
| **Sphere** : None | **Duration** : See Below |
...
| **Rank** : Mag 3 | **Casting Time** : 1 Minute |
| --- | --- |
| **Sphere** : None | **Duration** : 5 Minutes/Intensity |
| **Cost** : 3+1/additional Intensity | **Range** : Touch |
...
| **Rank** : Mag 1 | **Casting Time** : Instant |
| --- | --- |
...
| **Rank** : Mag 1 | **Casting Time** : 2d12 Hours |
| --- | --- |
...
| **Rank** : Mag 2 | **Casting Time** : 2 Actions |
| --- | --- |
| **Sphere** : None | **Duration** : Concentration |
| **Cost** : 3+1/additional Intensity | **Range** : Touch |
| **Area** : 20 ft. Radius | **Resist** : None |
...
| **Rank** : Clr 3 | **Casting Time** : 2 Actions |
| --- | --- |
| **Sphere** : Charm | **Duration** : 10 Minutes/Intensity |
| **Cost** : 3+1/additional Intensity | **Range** : Touch |
| **Area** : 1 Target | **Resist** : N/A |

When cast, this spell allows the subject to act normally throughout its Duration, regardless of other spells or effects that hinder movement or penalize attacks. This includes negating penalties from impeding terrain such as mud and snow. Under water, the subject may move at their normal land speed and swung weapons (swords, axes, clubs, maces, and so on) attack with full effect. This spell does not grant the ability to breath under water, however. This spell negates hindering spells, such as Entangle, Slow, Hold, Paralysis, Web, and so on, regarding movement and action penalties.
...
| **Rank** : Clr 4 | **Casting Time** : 1 Minute |
| --- | --- |
| **Sphere** : Healing | **Duration** : Permanent |
| **Cost** : 3+1/Intensity | **Range** : Touch |
...
| **Rank** : Clr 5 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Mag 1 | **Casting Time** : 1 Minute |
| --- | --- |
...
| **Rank** : Clr1, Mag 1 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Clr 3 | **Casting Time** : 1 Round |
| --- | --- |
| **Sphere** : Healing | **Duration** : Permanent |
| **Cost** : 3, +1/additional Intensity | **Range** : Touch |
...
| **Rank** : Clr 4 | **Casting Time** : 10 Minutes |
| --- | --- |
...
| **Rank** : Mag 4 | **Casting Time** : 1 Action |
| --- | --- |
| **Sphere** : None | **Duration** : Permanent |
...
| Avert | Might |
| --- | --- |
| Coordination | Protection (Self) |
| Darkvision | Preserve |
| Deflect | Know Languages |
| Detect Evil | Protection from Evil |
...
| **Rank** : Clr 3 | **Casting Time** : 1 Minute |
| --- | --- |
...
| **Rank** : Clr1, Mag 1 | **Casting Time** : 1 Minute |
| --- | --- |
...
| **Rank** : Clr0, Mag 0 | **Casting Time** : 1 Turn |
| --- | --- |
...
| **Rank** : Clr 4 | **Casting Time** : 3 Minutes |
| --- | --- |
| **Sphere** : Healing | **Duration** : Permanent |
| **Cost** : 3/Intensity | **Range** : Touch |
...
| **Rank** : Mag 4 | **Casting Time** : 10 Minutes |
| --- | --- |
| **Sphere** : None | **Duration** : Permanent |
...
| **Rank** : Clr 2, Mag 3 | **Casting Time** : 2 Actions |
| --- | --- |
| **Sphere** : ?? | **Duration** : Permanent |
| **Cost** : 3, +1/additiona Intensity | **Range** : Touch |
| **Area** : 1 Target | **Resist** : NA |
...
| **Rank** : Clr1, Mag 0 | **Casting Time** : 1 Action |
| --- | --- |
...
| **Rank** : Clr 3 | **Casting Time** : 3 Minutes |
| --- | --- |
| **Sphere** : Healing | **Duration** : Permanent |
| **Cost** : 3, +1/additional Intensity | **Range** : Touch |
| **Area** : 1 Target | **Resist** : NA |
...
| **Rank** : Clr 5 | **Casting Time** : 2 Actions |
| --- | --- |
...
| **Rank** : Clr 3, Mag 4 | **Casting Time** : 1 Round |
| --- | --- |
| **Sphere** : Divination | **Duration** : 1 Minute/Intensity |
| **Cost** : 3, +1/additional Intensity | **Range** : Touch |
| **Area** : 1 Target | **Resist** : NA |
...
| **Rank** : Clr 3, Mag 3 | **Casting Time** : 2 Actions |
| --- | --- |
...
| **Rank** : Mag 5 | **Casting Time** : See Below |
| --- | --- |
| **Sphere** : None | **Duration** : See Below |
...
| **Rank** : Clr 4 | **Casting Time** : 1 Action |
| --- | --- |
| **Sphere** : Summoning | **Duration** : See Below |
| **Cost** : 3, +1/additional Intensity | **Range** : 0 |
